...
\usepackage{array} % già caricato spesso, ma lo richiamo per sicurezza
\newcolumntype{C}{>{$}c<{$}} % colonna centrata in math-mode
...
\mainmatter
\include{prerequisiti}
\include{introduzione}
\include{preprocessing}
\include{insiemi_frequenti}
\include{clustering}
\include{classificazione}
\include{grafi}
\include{subgraphmatching}
\include{frequent_subgraphmatching}
